              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      PositionLocalizations.of(context).skip,
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 20.0,
                      ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              PositionLocalizations.of(context).title1,
                              style: kTitleStyle,
                            ),
                            const SizedBox(height: 15.0),
                            Text(
                              PositionLocalizations.of(context).subtitle1,
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            const SizedBox(height: 30.0),
                            Text(
                              PositionLocalizations.of(context).title2,
                              style: kTitleStyle,
                            ),
                            const SizedBox(height: 15.0),
                            Text(
                              PositionLocalizations.of(context).subtitle2,
                              style: kSubtitleStyle,
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            const SizedBox(height: 30.0),
                            Text(
                              PositionLocalizations.of(context).title3,
                              style: kTitleStyle,
                            ),
                            const SizedBox(height: 15.0),
                            Text(
                              PositionLocalizations.of(context).subtitle3,
                              style: kSubtitleStyle,
                            ),
                          ],
                        ),
                        ...
                        child: Align(
                          ...
                          child: TextButton(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text(
                                  PositionLocalizations.of(context).next,
              ...
              child: GestureDetector(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Text(
                      PositionLocalizations.of(context).go,
                      style: const TextStyle(
                        color: accentColor,
                        fontSize: 20.0,

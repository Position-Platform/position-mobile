...
class AppBloc extends HydratedBloc<AppEvent, AppState> {
  ...
  void _getSetting(GetSetting event, Emitter<AppState> emit) async {
    final token = await sharedPreferencesHelper!.getToken();
    final setting = await settingRepository!.getappsettings(token!);
    emit(SettingLoaded(state.themeData!, state.locale!, setting.success!));
  }
}
